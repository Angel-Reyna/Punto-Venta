...
- Name: auth-navigation.spec.ts >> autenticación y navegación principal >> vendedor no ve módulos administrativos ni puede entrar por ruta directa
- Location: e2e\auth-navigation.spec.ts:21:3
...
Expected pattern: /\/$/
Received string:  "http://127.0.0.1:5173/users"
Timeout: 7500ms

Call log:
  - Expect "toHaveURL" with timeout 7500ms
    18 × unexpected value "http://127.0.0.1:5173/users"
