...
- Name: catalog-smoke.spec.ts >> catálogo e inventario responsive >> productos carga catálogo y permite buscar por SKU
- Location: e2e\catalog-smoke.spec.ts:6:3
...
Locator: getByRole('heading', { name: 'Productos' })
Expected: visible
Timeout: 7500ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Productos' })
