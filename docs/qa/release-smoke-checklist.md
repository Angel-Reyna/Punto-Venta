...
- se tocaron ventas, productos, inventario, reportes, auditoría, usuarios o caja;
...
| --- | --- | --- |
| Inicio | Abrir `/` como admin. | Se ve un resumen operativo claro, sin acciones rápidas duplicadas ni dependencia visual de caja para vender. |
...
| Caja | Abrir/cerrar caja y registrar movimiento manual. | Caja comunica control de efectivo, pero no se interpreta como requisito para vender. |
...
| Nueva venta | Registrar venta en efectivo. | La venta se registra sin caja abierta. |
