...
- Middleware de autenticación, autorización por rol (`ADMIN`, `CASHIER`) y protección CSRF para endpoints que dependen de cookies de sesión.
...
2. Introducir autorización granular por permisos sin romper los roles actuales.
